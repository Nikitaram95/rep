...
public class ClaimTest {
    ...
    @Severity(value = SeverityLevel.CRITICAL)
    @Epic("Заявки")
    @Feature("Создание заявки с датой в прошлом")
    @Description("Создание заявки с невалидными данными (старая дата)")
    @Test
    ...
    @Severity(value = SeverityLevel.CRITICAL)
    @Epic("Заявки")
    @Feature("Создание заявки с датой в будущем")
    @Description("Создание заявки с невалидными данными (не наступившая дата)")
    @Test

...
public class AboutApp {
    ...
    ViewInteraction privacyPolicy = onView(withId(R.id.about_privacy_policy_value_text_view));
    ViewInteraction termsOfUse = onView(withId(R.id.about_terms_of_use_value_text_view));

    private val buttonBack = R.id.about_back_image_button;
    public val getButtonBack() {
        return buttonBack;
    }
